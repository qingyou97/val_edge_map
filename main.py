...
if __name__ == '__main__':
    ...
    angle_thresh = 15 # 两个峰值点与原点形成的夹角范围限制阈值 若在同一条直线上 设置为0

    ori_path = r'D:\Projects\edge_detection\rule_based\cast_def_0_2.jpeg'

    try:
        result = save_brighter_coordinates(ori_path, A, B, C, angle_thresh)
